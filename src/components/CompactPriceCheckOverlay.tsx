...
function tradePriceErrorLabel(error: string) {
  ...
  if (cooldown) return `TRADE COOLDOWN · ${cooldown[1].toUpperCase()}`;
  if (/timed out/i.test(error)) return "TRADE TIMED OUT · RETRY";
  return "TRADE SEARCH FAILED · RETRY";
}
